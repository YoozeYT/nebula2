        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-4 max-w-lg mx-auto" id="feature-selector-tabs">
            ...
            >
              ...
              <span>🛡️ Sicurezza & Protezione</span>
            </button>
          ...
          {activeTab === "security" && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center animate-fadeIn" id="feature-security">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <h3 className="font-display text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
                  Sicurezza infallibile, Anti-Nuke e Antispam
                </h3>
                <p className="text-sm sm:text-base text-slate-300 font-light leading-relaxed">
                  Mantieni la tua community pulita e al sicuro. Nebula blocca link sospetti, spam, mention mass e raid coordinati con anti-nuke, anti-raid, antilink, antispam e antimention.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                  ...
                  <div className="flex items-start gap-2.5">
                    <Shield className="h-5 w-5 text-rose-405 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-white">Anti-Nuke</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Blocca cambi di massa su ruoli, canali e permessi per fermare i takeover strutturati.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-2.5">
                    <Eye className="h-5 w-5 text-rose-405 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-white">Protezione Anti-Raid</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Rileva ondate di join e flooding coordinato, attivando lockdown e contromisure automatiche.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-2.5">
                    <Bell className="h-5 w-5 text-rose-405 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-white">Antimention e Antispam</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Ferma mass ping, spam ripetitivo e menzioni abusive prima che disturbino la community.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-black/30 rounded-xl p-3.5 border border-rose-500/20 text-xs flex gap-3">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 font-mono text-[10px]">
                        <span className="text-rose-300 font-bold">ANTI-NUKE BLOCK</span>
                        <span className="text-slate-500">•</span>
                        <span>07/06/2026 alle 12:05</span>
                      </div>
                      <p className="text-slate-205">
                        L'utente <strong className="text-white">RaidBot_992</strong> ha provato a innescare un flood di messaggi e mention massivo. Il sistema ha bloccato l'azione in tempo reale.
                      </p>
                      <p className="text-[10px] text-slate-400">
                        <strong>Canale bersagliato:</strong> #chat-del-server • <strong>Azione automatica:</strong> Lockdown + Timeout
                      </p>
                    </div>
                  </div>

                  <div className="bg-white/5 rounded-lg p-2.5 flex items-center justify-between border border-white/5 text-[10.5px]">
                    <span className="text-slate-400">Filtri attivi globali:</span>
                    <span className="text-green-400 font-mono font-bold">antilink, antispam, antimention</span>
                  </div>

                  <div className="bg-white/5 rounded-lg p-2.5 flex items-center justify-between border border-white/5 text-[10.5px]">
                    <span className="text-slate-400">Protezione anti-nuke:</span>
                    <span className="text-green-400 font-mono font-bold">ABILITATO ✓</span>
                  </div>

                  <div className="bg-white/5 rounded-lg p-2.5 flex items-center justify-between border border-white/5 text-[10.5px]">
                    <span className="text-slate-400">Protezione anti-raid:</span>
                    <span className="text-yellow-400 font-mono font-bold">ABILITATO ✓</span>
                  </div>
          ...
          {activeTab === "config" && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center animate-fadeIn" id="feature-config">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <p className="text-sm sm:text-base text-slate-300 font-light leading-relaxed">
                  Ogni server Discord è governato da una propria anima. Nebula lo sa e ti permette di gestire log, ticket e sicurezza con comandi slash nativi e impostazioni centralizzate, senza prefissi legacy.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
                  ...
                  <div className="flex items-start gap-2.5">
                    <Users className="h-5 w-5 text-indigo-400 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-white">Configurazione con /settings</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Apri il pannello di setup del server e aggiorna log, ticket e sicurezza da un unico comando.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    <Users className="h-5 w-5 text-indigo-400 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-white">Comandi Slash Nativi</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Usa solo slash commands moderni e veloci, senza prefissi tradizionali da ricordare.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    <Users className="h-5 w-5 text-indigo-400 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-sm font-semibold text-white">Moduli di Sicurezza</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Attiva o disattiva i moduli di protezione del server in modo rapido e controllato.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-6 bg-black/40 border border-white/10 rounded-2xl p-6 shadow-inner space-y-4 backdrop-blur-md">
                <div className="flex items-center justify-between pb-3 border-b border-white/5 text-xs">
                  <span className="font-mono text-cyan-300 font-bold">SETTINGS • STATO</span>
                ...
                <div className="bg-black/30 border border-white/5 p-4 rounded-xl space-y-3">
                  <div className="flex items-center justify-between text-xs text-white">
                    <span className="font-semibold">Comando principale:</span>
                    <code className="text-cyan-300 font-mono font-bold bg-black/35 px-1.5 py-0.5 rounded">/settings</code>
                  </div>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px]">
                    <div className="bg-white/5 rounded-lg border border-white/5 p-2.5">
                      <p className="text-slate-400 uppercase tracking-wider text-[9px] font-mono">Log sicurezza</p>
                      <p className="text-white font-semibold mt-0.5">#mod-logs</p>
                    </div>
                    <div className="bg-white/5 rounded-lg border border-white/5 p-2.5">
                      <p className="text-slate-400 uppercase tracking-wider text-[9px] font-mono">Ticket panel</p>
                      <p className="text-white font-semibold mt-0.5">Attivo</p>
                    </div>
                    <div className="bg-white/5 rounded-lg border border-white/5 p-2.5">
                      <p className="text-slate-400 uppercase tracking-wider text-[9px] font-mono">Comandi</p>
                      <p className="text-white font-semibold mt-0.5">Slash nativi</p>
                    </div>
                    <div className="bg-white/5 rounded-lg border border-white/5 p-2.5">
                      <p className="text-slate-400 uppercase tracking-wider text-[9px] font-mono">Sicurezza</p>
                      <p className="text-white font-semibold mt-0.5">Attiva</p>
                    </div>
                  </div>

                  <div className="border-t border-white/5 pt-3 flex items-center justify-between text-[11px]">
                    <span className="text-slate-400">Canale configurazione:</span>
                    <code className="text-cyan-300 font-mono font-bold bg-black/35 px-1.5 py-0.5 rounded">/settings</code>
                  </div>
                </div>
              </div>
