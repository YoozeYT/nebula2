        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-[#1b173a]">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-400 max-w-sm leading-relaxed font-light">
              Un bot Discord di nuova generazione concepito per unire sotto un'unica ala un velocissimo modulo ticket, protezione attiva anti-nuke, anti-raid, antilink, antispam e antimention, ed una configurazione per server capillare.
            </p>
