        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light">
              Un bot incredibilmente veloce, sicuro e completo. Automatizza l'assistenza con un sistema di ticket avanzato, proteggi i tuoi membri con anti-nuke, anti-raid, antilink, antispam e antimention, e applica una configurazione capillare adatta ad ogni tua esigenza.
            </p>
                  ...
                  <div className="space-y-4 pt-1">
                    <div>
                      ...
                      <div className="space-y-0.5">
                        <div className="flex items-center space-x-1.5 px-2 py-1 rounded hover:bg-white/5 cursor-pointer text-slate-400">
                          <span>#</span> <span className="truncate">📢-annunci-server</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-0.5">
                        ...
                        >
                          <span className="text-[#a5b4fc]">#</span> <span className="truncate">⚙️-settings</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border-b border-white/10 pb-2 mb-3 flex items-center justify-between text-xs">
                    <div className="flex items-center space-x-1.5">
                      ...
                      <span className="text-slate-400 truncate text-[11px]">
                        ...
                        {activeTab === "config" && "Configura log, ticket e sicurezza con /settings"}
                      </span>
                    </div>
                  </div>
                      ...
                      <div className="space-y-2 text-xs">
                        ...
                        <div className="border-l-4 border-emerald-500 bg-white/5 p-3 rounded-r-xl space-y-2 border-r border-t border-b border-white/5">
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="font-bold text-white text-xs">IMPOSTAZIONI SALVATE</span>
                          </div>
                          <p className="text-slate-300 text-[11px]">
                          ...
                          <p className="text-[10px] text-slate-500 font-mono">
                            Comando principale: <code className="bg-[#202225] px-1 py-0.5 rounded text-indigo-300">/settings</code>
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="mt-4 pt-2 border-t border-white/10 flex items-center justify-between gap-2">
                    <div className="flex-1 bg-black/40 rounded-lg px-3 py-2 flex items-center text-slate-500 text-[11px] font-sans border border-white/10">
                      ...
                      <span className="flex-1 select-none text-slate-405">
                        ...
                        {activeTab === "security" && "La protezione anti-nuke, anti-raid, antilink, antispam e antimention è attiva a livello globale..."}
                        {activeTab === "config" && "Digita un comando qui... (es: /settings)"}
                      </span>
