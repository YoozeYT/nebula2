...
export const COMMANDS_DATA: Command[] = [
  ...
  },
  {
    ...
    description: "Blocca cancellazioni di massa, modifiche sospette a ruoli e permessi, e tentativi di takeover strutturati.",
    usage: "/security antinuke [stato: true/false] [sensibilita: opzionale]",
    example: "/security antinuke true high",
    category: "security",
    permissions: "Manage Server"
  },
  {
    name: "/security antiraid",
    description: "Rileva ondate di join e flooding coordinato, attivando difese automatiche contro i raid.",
    usage: "/security antiraid [stato: true/false] [soglia: opzionale]",
    example: "/security antiraid true 12",
    category: "security",
    permissions: "Manage Server"
  },
  {
    name: "/security antimention",
    description: "Ferma mass ping, mention spam e catene abusive di menzioni prima che disturbino il server.",
    usage: "/security antimention [stato: true/false] [soglia_menzioni]",
    example: "/security antimention true 5",
    category: "security",
    permissions: "Manage Server"
  },
  {
  ...
  {
    name: "/settings",
    description: "Apre il pannello di configurazione principale del bot nel server.",
    usage: "/settings",
    example: "/settings",
    category: "config",
    permissions: "Manage Server"
  ...
  {
    name: "/settings logs",
    description: "Configura il canale log dedicato agli eventi di moderazione e sicurezza.",
    usage: "/settings logs [canale] [filtro: all/mod/messages/joins]",
    example: "/settings logs #mod-logs all",
    category: "config",
    permissions: "Manage Server"
  },
  {
    name: "/settings tickets",
    description: "Configura il pannello ticket e le impostazioni operative del sistema di supporto.",
    usage: "/settings tickets [canale] [ruolo_supporto] [categoria_ticket]",
    example: "/settings tickets #ticket @Staff 🎫 TICKET-ARCHIVIO",
    category: "config",
    permissions: "Manage Server"
  },
